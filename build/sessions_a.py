...
# =====================================================================
{
 ...
 "mon": "Mon Sep 14",
 "fri": "Fri Sep 18",
 "new": ["print", "naming a value", "reassignment", "input", "int()", "f-string", "reading a NameError"],
 "reuse": None,
 ...
 "chunks": [
  ...
  {"title": "int() converts, on one line of its own",
   "teach": "<code>int()</code> takes text that looks like a whole number and hands back the number. Do the conversion on its own line while you are learning. You will see it folded into one line in other people's code later.",
   "code": 'age = input("Robot age in years: ")\nage = int(age)\nprint(age + 1)',
   "stdin": "3\n",
   "run": "py",
   "predict": "Same program with one line added. What changes?",
   "reveal": "Now <code>age</code> holds the number 3 rather than the text 3, so adding 1 works. This trap comes back every time a program asks for a number, so it goes on your ledger card today."},
 ...
 "brief": {
   ...
   "steps": [
     ...
     "Ask for a height in inches, and convert it to a number on its own line.",
     "Ask for a number of tickets, and convert it.",
 ...
 "exits": {
   ...
   "middle": "The full rider card: three questions, two conversions, two printed sentences.",
 ...
 "ledger": "Stamp 1: <code>print</code>, <code>name = value</code>, <code>input</code> hands back text, <code>int()</code> converts, <code>f\"{name}\"</code>. Write the TypeError message from chunk 5 on the card in your own handwriting.",
 "teacher": {
   "timing": [
     "0:00 setup and house rule, 10 min",
     "0:10 chunks 1 to 4, 20 min (fast; most students have seen print)",
     "0:30 chunks 5 and 6, the int() trap, 15 min (slow down here)",
     "0:45 chunk 7 f-strings, 10 min",
